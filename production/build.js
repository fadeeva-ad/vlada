...
var map = {
	...
	"./style-fix.js": "./dev/js/custom-scripts/style-fix.js"
};
...
/* harmony import */ var _mainJs_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../mainJs.js */ "./dev/js/mainJs.js");



_mainJs_js__WEBPACK_IMPORTED_MODULE_1__["axlab"].sliders = {
    storySlider: function () {
        var storySlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".block-5 .swiper-container", {
            loop: true,
            effect: 'fade',
            fadeEffect: {
                crossFade: true
    ...
    defaultSlider: function () {
        let defaultSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".default-slider", {
            loop: true,
            slidesPerView: 1,
            effect: 'fade',
            fadeEffect: {
    ...
    verticalSlider: function () {
        var verticalSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".prepods-slider .swiper-container", {
            loop: true,
            slidesPerView: 1,
            effect: 'fade',
            autoHeight: true,
    ...
    init: function () {
        _mainJs_js__WEBPACK_IMPORTED_MODULE_1__["axlab"].sliders.storySlider();
        _mainJs_js__WEBPACK_IMPORTED_MODULE_1__["axlab"].sliders.defaultSlider();
        _mainJs_js__WEBPACK_IMPORTED_MODULE_1__["axlab"].sliders.verticalSlider();
    }
};

$(function () {
    _mainJs_js__WEBPACK_IMPORTED_MODULE_1__["axlab"].sliders.init();
});

/***/ }),

/***/ "./dev/js/custom-scripts/style-fix.js":
/*!********************************************!*\
  !*** ./dev/js/custom-scripts/style-fix.js ***!
  \********************************************/
/*! no exports provided */
...
_mainJs_js__WEBPACK_IMPORTED_MODULE_1__["axlab"].styleFix = {
    mainBanner: function () {
    ...
    init: function () {
        $(window).on("resize", _mainJs_js__WEBPACK_IMPORTED_MODULE_1__["axlab"].styleFix.mainBanner());
        _mainJs_js__WEBPACK_IMPORTED_MODULE_1__["axlab"].styleFix.mainBanner();
        _mainJs_js__WEBPACK_IMPORTED_MODULE_1__["axlab"].styleFix.block11();
    }
};

$(function () {
    _mainJs_js__WEBPACK_IMPORTED_MODULE_1__["axlab"].styleFix.init();
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*	jQuery.flexMenu 1.5
...
/*!**************************!*\
  !*** ./dev/js/mainJS.js ***!
  \**************************/
/*! exports provided: axlab */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "axlab", function() { return axlab; });
var axlab = {};
...
const Virtual = {
  ...
  renderSlide(slide, index$$1) {
    ...
    const $slideEl = params.renderSlide ? Object(dom7_dist_dom7_modular__WEBPACK_IMPORTED_MODULE_0__["$"])(params.renderSlide.call(swiper, slide, index$$1)) : Object(dom7_dist_dom7_modular__WEBPACK_IMPORTED_MODULE_0__["$"])(`<div class="${swiper.params.slideClass}" data-swiper-slide-index="${index$$1}">${slide}</div>`);
...
const Parallax = {
  ...
  setTranslate() {
    ...
    slides.each((slideIndex, slideEl) => {
      ...
      Object(dom7_dist_dom7_modular__WEBPACK_IMPORTED_MODULE_0__["$"])(slideEl).find('[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]').each((index$$1, el) => {
